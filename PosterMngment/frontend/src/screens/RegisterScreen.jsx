...
const RegisterScreen = () => {
  ...
  const [confirmPassword, setConfirmPassword] = useState(''); // Updated here
  ...
  const submitHandler = async (e) => {
    ...
    const response = await fetch('http://localhost:5000/api/users', {
      ...
      body: JSON.stringify({ username, password, confirmPassword, role: selectedRole }), // Updated here
    });
      ...
      <Row className='justify-content-md-center'>
        <Col xs={12} md={6}>
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='confirmPassword'> {/* Updated controlId here */}
              <Form.Label>Confirm Password</Form.Label>
              <Form.Control
                type='password'
                placeholder='Confirm Password'
                value={confirmPassword} // Updated here
                onChange={(e) => setConfirmPassword(e.target.value)} // Updated here
              ></Form.Control>
            </Form.Group>
